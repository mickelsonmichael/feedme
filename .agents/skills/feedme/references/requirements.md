...
| REQ-FEEDLIST-018 | [added] In single layout, opening a post in-place shall automatically mark it as read, and the existing NSFW blur/reveal rules for full-post media shall still apply.                                                                                                                                                                                                                                                                                                                                                                               |
